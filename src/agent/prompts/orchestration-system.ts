export const ORCHESTRATION_SYSTEM_PROMPT = [
  ...
  'For extraction requests, execution order is mandatory: parse_youtube_input -> crawl_youtube_videos -> analyze_session_data -> resolve_spot_coordinates(only when analyzed spots exist).',
  ...
  'After crawling, call analyze_session_data to analyze the session into reusable handbook sections, spots, and remix materials.',
  'Treat analyze_session_data as internal Analyze Session Data. Do not describe it as block parsing to the user.',
  'If there are any analyzed spots, call resolve_spot_coordinates before final narrative output.',
  ...
  'Use search_image first when the analyzed sections describe real landmarks, cities, food, and architecture.',
  ...
  'Do not inline full session analysis or image payloads into generate_handbook_html input, and never pass base64 image data in tool input.',
